...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DBINDEX_ITERATOR_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DBINDEX_ITERATOR_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DBINDEX_ITERATOR_H
