...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_DATABASESTORAGE_DBTRIGRAM_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_DATABASESTORAGE_DBTRIGRAM_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANGD_DATABASESTORAGE_DBTRIGRAM_H
