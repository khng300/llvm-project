...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_DOCUMENTSTOREQUERY_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_DOCUMENTSTOREQUERY_H
...
private:
  ...
  std::unique_ptr<DocumentStoreImpl::TransactionImpl> Snapshot;
