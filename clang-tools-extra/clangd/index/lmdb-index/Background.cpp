...
#include "index/lmdb-index/IndexDBError.h"
#include "index/lmdb-index/LMDBError.h"
...
BackgroundIndex::BackgroundIndex(llvm::StringRef WorkspaceRoot,
    ...
    : SwapIndex(std::make_unique<MemIndex>()), TFS(TFS), CDB(CDB),
      ...
      LMDBInstance(lmdb_index::createSharedDatabase(WorkspaceRoot)),
...
void BackgroundIndex::update(
  ...
  do {
    CommitEC = [&]() {
      auto TxnOrErr = LMDBInstance->beginTransaction(false, MainFile);
      if (!TxnOrErr)
