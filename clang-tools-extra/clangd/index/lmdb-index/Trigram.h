...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TRIGRAM_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TRIGRAM_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TRIGRAM_H
