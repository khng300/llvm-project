...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_LMDB_INDEX_TRIGRAM_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_LMDB_INDEX_TRIGRAM_H
...
public:
  ...
  std::string_view view() const {
    return std::string_view(Data.data(), Data[3]);
  }
  friend struct ::llvm::DenseMapInfo<Trigram>;
  friend struct ::std::hash<Trigram>;
...
namespace llvm {
template <> struct DenseMapInfo<clang::clangd::lmdb_index::Trigram> {
  using Trigram = clang::clangd::lmdb_index::Trigram;
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_LMDB_INDEX_TRIGRAM_H
