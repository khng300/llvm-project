...
cl::SymbolID DocumentStoreImpl::TransactionImpl::MarshallingHelper::fromNative(
    clangd::SymbolID V) {
  cl::SymbolID R;
...
clangd::SymbolID
DocumentStoreImpl::TransactionImpl::MarshallingHelper::toNative(
    cl::SymbolID V) {
...
cl::FileDigest
DocumentStoreImpl::TransactionImpl::MarshallingHelper::fromNative(
    clangd::FileDigest V) {
  cl::FileDigest R;
...
cl::Relation DocumentStoreImpl::TransactionImpl::MarshallingHelper::fromNative(
