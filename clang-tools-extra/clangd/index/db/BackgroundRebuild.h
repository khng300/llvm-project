...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_BACKGROUNDREBUILD_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_BACKGROUNDREBUILD_H
...
public:
  BackgroundIndexRebuilder(SwapIndex *Target,
                           std::shared_ptr<db_index::LMDB> Source,
                           unsigned Threads)
