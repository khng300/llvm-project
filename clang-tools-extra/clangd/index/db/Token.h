...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TOKEN_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TOKEN_H
...
template <> struct DenseMapInfo<clang::clangd::db_index::Token> {
  static inline clang::clangd::db_index::Token getEmptyKey() {
    return {clang::clangd::db_index::Token::Kind::Sentinel, "EmptyKey"};
  }

  static inline clang::clangd::db_index::Token getTombstoneKey() {
    return {clang::clangd::db_index::Token::Kind::Sentinel, "TombstoneKey"};
  }

  static unsigned getHashValue(const clang::clangd::db_index::Token &Tag) {
    return hash_value(Tag);
  }

  static bool isEqual(const clang::clangd::db_index::Token &LHS,
                      const clang::clangd::db_index::Token &RHS) {
    return LHS == RHS;
  }
};
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_TOKEN_H
