...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_BACKGROUNDINDEXLOADER_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANGD_INDEX_DB_BACKGROUNDINDEXLOADER_H
...
struct LoadedShard {
  ...
  Path AbsolutePath;
  /// Modification time of the source file that produced this shard.
  ...
  /// AbsolutePath.
  std::unique_ptr<IncludeGraph> Shard;
};
